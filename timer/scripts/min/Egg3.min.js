var Egg = {name: "EggTimer",defaultText: "",expiredMessage: "Time Expired!",title: "",label: "",progress: 0,startTime: 0,endTime: 0,totalTime: 0,parseError: "",progressBar: null,progressText: null,staticArea: null,beep: null,currDate: null,endDate: null,ticker: null,startButton: null,volume: 1,sequence: [],canAlert: true,start: function() {
        ...
        if (Time.remainingDays > 0) {
            ...
            Time.remainingHours += Time.remainingDays*24;
        }
        
        // if (Time.remainingHours > 0) {
            clockTime.push(padTimeText(Time.remainingHours) + "h");
            hourText = getTimeText(numberFormat(Time.remainingHours), ":");
            
        // }
        
        // if (Time.remainingMinutes > 0) {
            clockTime.push(padTimeText(Time.remainingMinutes));
            minText = getTimeText(numberFormat(Time.remainingMinutes), ":");
        // } else {
        ...
        // if (Time.remainingSeconds > 0) {
            ...
            secText = numberFormat(Time.remainingSeconds);
        // } else {
        //     clockTime.push(padTimeText(0))
        // }
        ...
        if (Egg.sequence.length === 0) {
            ...
            Egg.progressText.css("font-family", "sans-serif");
            Egg.showAlert()
        } else {
